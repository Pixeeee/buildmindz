...
// ── Wordmark letters — slide up individually on scroll ───────────────────────
...
function Newsletter() {
  ...
  return (
    <form onSubmit={submit} className="ft-newsletter">
      ...
      {status === 'sent' && (
        <p className="ft-nl-confirm">You're on the list.</p>
      )}
    </form>
  );
}
    ...
    <footer className="ft-footer">
      ...
      <div className="ft-top">
        <div className="ft-top-left">
          ...
          <h3 className="ft-nl-heading">Get our latest<br /><em>thinking & work.</em></h3>
          <Newsletter />
        </div>
          ...
          <div className="ft-nav-col">
            ...
            <ul className="ft-nav-list">
              {SOCIAL_LINKS.map(({ label, href, icon }) => (
                <li key={label}>
                  <a href={href} className="ft-nav-link ft-social-link" target="_blank" rel="noreferrer" aria-label={label}>
